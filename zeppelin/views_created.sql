create view sth_stage_adopted_level_organization_view as select 
...
from 
questionnaire_adoptedlevel adopted_level  
left outer join questionnaire_answer answer on answer.adopted_level_id = adopted_level.id 
inner join questionnaire_statement qs on qs.id = answer.statement_id 
...
inner join practitioners_eye_category pec on pec.id = pee.category_id  
