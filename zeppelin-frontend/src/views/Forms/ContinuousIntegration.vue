...
import QUESTIONS from '@/data/continuous_integration.json'
import { useQuestionnaire } from '@/composables/useQuestionnaire'

const pageTitle = 'Continuous Integration'
const { answers, left, right, submit, isSubmitting, submitError, submitSuccess } = useQuestionnaire(QUESTIONS as any, 'continuous_integration')
</script>
