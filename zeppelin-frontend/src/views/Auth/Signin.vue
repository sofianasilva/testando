              ...
              <div>
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      <router-link
                        to="/password-reset"
                        class="text-sm text-brand-950 hover:text-brand-900 dark:text-brand-900"
                ...
                <div class="mt-5">
                  ...
                  >
                    ...
                    <router-link
                      to="/signup"
                      class="text-brand-950 hover:text-brand-900 dark:text-brand-900"
                      >Sign Up</router-link
                    >
                  </p>
                </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = error.response?.data?.error_description || 'Falha ao tentar logar'
  }
}
</script>